...
func (r *ImageMirrorDigestSetReconciler) generateRegistryConfig(instance *configv1alpha1.ImageMirrorDigestSet) error {
	...
	// Log that CRI-O should be reloaded to pick up the new configuration
	log.Info("Registry configuration updated, CRI-O should be reloaded to pick up changes", 
...
// signalCRIOReload creates a signal file to indicate that CRI-O should be reloaded
func (r *ImageMirrorDigestSetReconciler) signalCRIOReload() error {
	// Create a signal file that can be monitored by external processes
